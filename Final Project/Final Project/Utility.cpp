...
glm::mat4 Utility::get_view_matrix(const glm::vec3& camPos) {
    return glm::translate(glm::mat4(1.0f), glm::vec3(-camPos.x, -camPos.y, 0.0f));
}

glm::mat4 Utility::get_projection_matrix(float left, float right, float bottom, float top) {
